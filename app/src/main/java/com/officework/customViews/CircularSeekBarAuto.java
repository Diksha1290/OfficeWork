...
public class CircularSeekBarAuto extends View {
...
//            }
    ...
    public CircularSeekBarAuto(Context context) {
        super(context);
        init(null, 0);
    }

    public CircularSeekBarAuto(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public CircularSeekBarAuto(Context context, AttributeSet attrs, int defStyle) {
    ...
    public interface OnCircularSeekBarChangeListener {
        ...
        public abstract void onProgressChanged(CircularSeekBarAuto circularSeekBar, float progress, boolean fromUser);

        public abstract void onStopTrackingTouch(CircularSeekBarAuto seekBar);

        public abstract void onStartTrackingTouch(CircularSeekBarAuto seekBar);
    }
