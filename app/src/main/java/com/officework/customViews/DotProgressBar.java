...
public class DotProgressBar extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (getMeasuredHeight() > getMeasuredWidth()) {
            dotRadius = getMeasuredWidth() / dotAmount / 12;
        } else {
            dotRadius = getMeasuredHeight() / 12;
        }
    ...
    private void initializeAttributes(AttributeSet attrs) {
        if (attrs != null) {
            TypedArray a = getContext().getTheme().obtainStyledAttributes(attrs, R.styleable.DotProgressBar, 0, 0);
            
            try {
                setDotAmount(a.getInteger(R.styleable.DotProgressBar_amount, 3));
                setAnimationTime(animationTime = a.getInteger(R.styleable.DotProgressBar_duration, getResources().getInteger(android.R.integer.config_mediumAnimTime)));
                setStartColor(a.getInteger(R.styleable.DotProgressBar_startColor, ContextCompat.getColor(getContext(), R.color.gray_color)));
                setEndColor(a.getInteger(R.styleable.DotProgressBar_endColor, ContextCompat.getColor(getContext(), R.color.green_color)));
            ...
            setStartColor(ContextCompat.getColor(getContext(), R.color.gray_color));
            setEndColor(ContextCompat.getColor(getContext(), R.color.green_color));
  ...
  public   void setDotAmount(int amount) {
   ...
   public void setEndColor(@ColorInt int color) {
    ...
    public void stop(long animationTime){
        stopAnimation();
