...
class FaceOverlayGraphics extends CameraOverlay.OverlayGraphic {
    ...
    private FaceDetectionInterface callBackInterface;
    private boolean shouldend=true;

    FaceOverlayGraphics(CameraOverlay overlay,FaceDetectionInterface callBackInterface) {
        super(overlay);
...
//       else if(id>=1)
//        {
//            callBackInterface.finishcallBack();
//
//        }
